...
def build_conv_layer() -> tf.keras.layers.Conv2D:
    ...
    my_layer = tf.keras.layers.Conv2D(filters=2, kernel_size=(5, 5), strides=4)
    return my_layer
...
def build_padded_conv_layer(kernel_size) -> tf.keras.layers.Conv2D:
    ...
    my_layer = tf.keras.layers.Conv2D(filters=2,
...
def build_up_conv_layer() -> tf.keras.layers.Conv2DTranspose:
    ...
    my_layer = tf.keras.layers.Conv2DTranspose(filters=4,
                                               kernel_size=(3, 3),
                                               strides=(2, 2))
    return my_layer
